...
$ESXiLockDown = Get-vCheckvSphereObject "Hosts" | Where {$_.ConnectionState -match "Connected|Maintenance" -and $_.ExtensionData.Summary.Config.Product.Name -match "i" -and $_.LockedMode -eq $false} | Select Name, @{N="LockedMode";E={$_.ExtensionData.Config.AdminDisabled}} 
